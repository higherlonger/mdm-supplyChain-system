...
<div> 
    ...
    <nav class="app-location-wrapper">
        <el-breadcrumb separator="/" class="fl">
            ...
            <el-breadcrumb-item>原料退货</el-breadcrumb-item>
        </el-breadcrumb>
...
<script>
import { getMaterialReturn,getMaterialReturnExp } from "../../api";
...
export default {
  ...
  methods: {
    ...
    outReport() {
      addData({
        requestUrl: getMaterialReturnExp,
