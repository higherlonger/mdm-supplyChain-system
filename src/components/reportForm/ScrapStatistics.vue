...
<div> 
    ...
    <nav class="app-location-wrapper">
        <el-breadcrumb separator="/" class="fl">
            ...
            <el-breadcrumb-item>废弃统计</el-breadcrumb-item>
        </el-breadcrumb>
...
<script>
import { getScrapStatistics,getScrapStatisticsExp } from "../../api";
...
export default {
  ...
  methods: {
    ...
    outReport() {
      addData({
        requestUrl: getScrapStatisticsExp,
