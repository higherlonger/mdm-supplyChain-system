...
<div> 
    ...
    <nav class="app-location-wrapper">
        <el-breadcrumb separator="/" class="fl">
            ...
            <el-breadcrumb-item>门店报表</el-breadcrumb-item>
            <el-breadcrumb-item>退货统计</el-breadcrumb-item>
        </el-breadcrumb>
...
<script>
import { getReturnStatistics,getReturnStatisticsExp } from "../../api";
...
export default {
  ...
  methods: {
    ...
    searchHandle(val) {
      ...
      getListPage({
        requestUrl: getReturnStatistics,
        params: { ...this.search }
      }).then(item => {
    ...
    outReport() {
      addData({
        requestUrl: getReturnStatisticsExp,
